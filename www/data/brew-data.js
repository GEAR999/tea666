// 泡饮百科 - 扩展数据
// 花草茶、中药材、养生茶饮、果茶类
// 数据来源：《本草纲目》《中国药典》2025版、卫健委药食同源目录、北京市中医药管理局
...
const BREW_DATA = {
  ...
  sources: {
    ...
    foodMedicine: "卫健委药食同源目录（2023年更新）",
    beijingTcm: "北京市中医药管理局养生指南（2024）"
  },
  ...
  flowerTeas: [
    {
      ...
      varieties: [
        { name: "杭白菊", feature: "浙江桐乡产，花瓣洁白，味甘微苦" },
        { name: "胎菊", feature: "未完全开放的花蕾，品质更佳" },
        { name: "野菊花", feature: "花朵较小，味苦，清热解毒力更强" },
        { name: "贡菊", feature: "安徽黄山产，花瓣洁白，花心小" }
      ],
      source: "《本草纲目》草部第十五卷"
    },
    {
